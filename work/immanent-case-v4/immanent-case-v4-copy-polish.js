(function () {
  ...
  const replacements = new Map([
    ...
    [
      "一个可说明的柚子来源，发展成两条清楚的产品路径：PEEL 负责贴肤香气，PULP 负责低甜度定量调饮。",
      "同一颗柚子，发展出两条清楚的产品路径：PEEL 贴近肌肤，PULP 用来定量调饮。"
    ],
    [
    ...
    [
      "IMMANENT 指向“原本就在其中”的东西；“蕴”也有内在、积蓄、等待被引出的意思。这个名字让品牌回到原料本身，而不是再造一个与产品无关的故事。",
      "IMMANENT 指向“原本就在其中”的东西；“蕴”也有内在、积蓄、慢慢被引出的意思。这个名字把品牌带回原料本身，而不是另编一个与产品无关的故事。"
    ],
    [
